# Context Management — AIOX Optimization Rules

> Gestao de contexto, subagentes e janela de contexto. Origem: ~360 sessoes, Central MKT.

## Orion = Coordenacao SOMENTE
...
**MEMORY.md save policy:** MEMORY.md e atualizado SOMENTE no threshold RED ou evento /compact. NUNCA antes. Saves prematuros desperdicam tokens e contexto.

## /compact ou System Compression
...
> Essencial para maquinas com <= 16 GB RAM.
