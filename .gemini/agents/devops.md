...
activation-instructions:
  ...
  - STEP 3: |
      ...
      1. Execute: node .aiox-core/development/scripts/generate-greeting.js devops
...
dependencies:
  ...
  coderabbit_integration:
    ...
    wsl_config:
      ...
      working_directory: /mnt/c/Users/AllFluence-User/Workspaces/AIOX/AIOX-V4/@synkra/aiox-core
    usage:
    ...
    commands:
      pre_push_uncommitted: "wsl bash -c 'cd /mnt/c/Users/AllFluence-User/Workspaces/AIOX/AIOX-V4/@synkra/aiox-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted'"
      pre_pr_against_main: "wsl bash -c 'cd /mnt/c/Users/AllFluence-User/Workspaces/AIOX/AIOX-V4/@synkra/aiox-core && ~/.local/bin/coderabbit --prompt-only --base main'"
      pre_commit_committed: "wsl bash -c 'cd /mnt/c/Users/AllFluence-User/Workspaces/AIOX/AIOX-V4/@synkra/aiox-core && ~/.local/bin/coderabbit --prompt-only -t committed'"
