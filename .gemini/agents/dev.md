...
dependencies:
  ...
  coderabbit_integration:
    ...
    commands:
      dev_pre_commit_uncommitted: "wsl bash -c 'cd /mnt/c/Users/AllFluence-User/Workspaces/AIOX/AIOX-V4/@synkra/aiox-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted'"
