...
dependencies:
  ...
  coderabbit_integration:
    ...
    workflow: |
      ...
      1. Run: wsl bash -c 'cd /mnt/c/Users/AllFluence-User/Workspaces/AIOX/AIOX-V4/@synkra/aiox-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted' (for ongoing work)
      2. Or: wsl bash -c 'cd /mnt/c/Users/AllFluence-User/Workspaces/AIOX/AIOX-V4/@synkra/aiox-core && ~/.local/bin/coderabbit --prompt-only --base main' (for feature branches)
