...
dependencies:
  ...
  coderabbit_integration:
    ...
    commands:
      qa_pre_review_uncommitted: "wsl bash -c 'cd /mnt/c/Users/AllFluence-User/Workspaces/AIOX/AIOX-V4/@synkra/aiox-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted'"
      qa_story_review_committed: "wsl bash -c 'cd /mnt/c/Users/AllFluence-User/Workspaces/AIOX/AIOX-V4/@synkra/aiox-core && ~/.local/bin/coderabbit --prompt-only -t committed --base main'"
