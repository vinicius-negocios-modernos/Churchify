...
activation-instructions:
  ...
  - STEP 3: |
      ...
      1. Execute: node .aiox-core/development/scripts/generate-greeting.js data-engineer
...
coderabbit_integration:
  ...
  workflow: |
    ...
    1. BEFORE migration: Run wsl bash -c 'cd /mnt/c/Users/AllFluence-User/Workspaces/AIOX/AIOX-V4/@synkra/aiox-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted' on migration files
    2. Focus review on:
